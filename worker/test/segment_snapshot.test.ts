...
import type { SegmentDwellDoc, SegmentFlowDoc, SegmentParamsDoc, StationFlowDoc } from '../src/state';
...
function regime(state: 'normal' | 'disrupted', enteredAt: number): RegimeEntry<'normal' | 'disrupted'> {
  return {
    state,
