...
def test_hour_of_wraps_after_midnight_trips() -> None:
    # GTFS encodes an after-midnight departure on the prior service day as
    # 24:xx/25:xx; % 24 recovers the wall-clock hour it actually runs.
    assert hour_of("08:14:00") == 8
    assert hour_of("25:10:00") == 1
    assert hour_of("24:00:00") == 0
